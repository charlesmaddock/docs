...
The `Page` class represents a page in the Dendrite browser instance, it corresponds to a _tab_ in a traditional browser browser. It provides methods for interacting with and manipulating webpages.
